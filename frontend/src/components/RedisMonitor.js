const RedisMonitor = ({ redisStats }) => {
  ...
  const getCacheHealthColor = (hitRatio) => {
    ...
    if (hitRatio >= 60) return 'var(--warning-orange)';
        ...
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.875rem' }}>
          ...
          <div style={{ 
            ...
            backgroundColor: performance.cache_hit_ratio >= 80 ? 'var(--success-green)' : 
                           performance.cache_hit_ratio >= 60 ? 'var(--warning-orange)' : 'var(--error-red)',
          ...
          <div style={{ 
            ...
            justifyContent: 'space-between', 
            padding: '8px 12px',
            backgroundColor: inflight_transactions.total > 100 ? 'var(--warning-orange)' : 'var(--success-green)',
