...
const PaymentReconciliation = () => {
 ...
 case 'Pending Payment': return 'WAIT';
 default: return 'BOX';
 }
 };
 ...
 case 'Pending Payment': return 'var(--accent-orange)';
 ...
 <div style={{ fontSize: '2rem', marginBottom: 'var(--space-2)' }}>CHART</div>
 ...
 {/* Live Payment Trends Chart */}
 <div className="card">
 <div className="card-header">
 <h3 className="card-title">Live Payment Trends</h3>
 <div style={{ 
 display: 'flex', 
 alignItems: 'center', 
 gap: 'var(--space-2)',
